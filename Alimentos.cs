...
{
    public class Alimentos : Almacén
    {

        public Alimentos(string nombre, string marca, string categoria, double precio, uint cantidad)
        {
            Nombre = nombre;
            Marca = marca;
            Categoria = categoria;
        ...
        public Alimentos(string marca, string nombre)
        {
        ...
        public Alimentos(double precio, uint cantidad)
        {
            Precio = precio; Unidad = cantidad;
        }
        public Alimentos(string categoria, uint cantidad)
        {
