...
{
    public class Farmacia : Almacén
    {
        public Farmacia(string nombre, string marca, string categoria, double precio, uint cantidad)
        {
            Nombre = nombre;
            Marca = marca;
            Categoria = categoria;
        ...
        public Farmacia(string marca, string nombre)
        {
        ...
        public Farmacia(double precio, uint cantidad)
        {
            Precio = precio; Unidad = cantidad;
        }
        public Farmacia(string categoria, uint cantidad)
        {
