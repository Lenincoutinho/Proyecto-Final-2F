...
{
    public class Electrodomesticos : Almacén
    {
        public Electrodomesticos(string nombre, string marca, string categoria, double precio, uint cantidad)
        {
            Nombre = nombre;
            Marca = marca;
            Categoria = categoria;
        ...
        public Electrodomesticos(string marca, string nombre)
        {
        ...
        public Electrodomesticos(double precio, uint cantidad)
        {
            Precio = precio; Unidad = cantidad;
        }
        public Electrodomesticos(string categoria, uint cantidad)
        {
